"""
Simple Terminal User Interface for Pi Configurator
...
class SimpleTUI:
    """Simple Terminal User Interface for configuration."""
...
class SimpleTUIHandler:
    """Handler for simple TUI operations."""
    ...
    def run(self) -> None:
        """Run the simple TUI."""
        tui = SimpleTUI(self.config_manager)
        tui.run()